...
# Use DenseNet121 weights and corresponding transforms
...
print("Lade und passe DenseNet an...")
...
tracker = EmissionsTracker(output_file="emissions_densenet.csv")
tracker.start()
...
torch.save(model.state_dict(), "damaged_packages_densenet_epoch.pth")
print("Modell gespeichert: 'damaged_packages_densenet_epoch.pth'")