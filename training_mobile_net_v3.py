...
print("Lade und passe MobileNetV3 an...")
...
tracker = EmissionsTracker(output_file="emissions_mobilenetv3.csv")
tracker.start()
...
torch.save(model.state_dict(), "damaged_packages_mobilenetv3_epoch.pth")
print("Modell gespeichert: 'damaged_packages_mobilenetv3_epoch.pth'")
